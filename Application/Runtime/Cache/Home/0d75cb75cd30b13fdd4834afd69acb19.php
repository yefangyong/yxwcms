			...
			<div class="row">
				<div class="col-sm-9 col-md-9">
					...
					<div class="news-comments">
						<?php if(is_array($result[comments])): $i = 0; $__LIST__ = $result[comments];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comment): $mod = ($i % 2 );++$i;?><div class="panel panel-info">
