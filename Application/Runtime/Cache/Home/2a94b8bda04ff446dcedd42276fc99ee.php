<?php if (!defined('THINK_PATH')) exit(); $config = D('Basic')->select(); $navs = D('Menu')->getBarMenu(); ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
      ...
      <div class="col-sm-9 col-md-9">
        <div class="banner">
          <div class="banner-left">
              ...
              <a href="/index.php?c=detail&id=<?php echo ($result['topPicNews'][0]['news_id']); ?>" target="_blank"> <img src="<?php echo ($result['topPicNews'][0]['thumb']); ?>" alt=""></a>
          </div>
          <div class="banner-right">
            <ul>
              <?php if(is_array($result['topSmallNews'])): $i = 0; $__LIST__ = $result['topSmallNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <a href="/index.php?c=detail&id=<?php echo ($vo["news_id"]); ?>" target="_blank"> <img  src="<?php echo ($vo["thumb"]); ?>" width="200" height="120" alt="<?php echo ($vo["title"]); ?>"></a>
