...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">DDos拦截设置</h1>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="alert alert-info alert-dismissable">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          PHP仅提供应用层的DDos拦截，如有持续大规模DDos请启用硬件防火墙。 </div>
              ...
              <div class="col-lg-6">
                <form name="ddos_form" method="post" id="singcms-form">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="统计时间阈值" name="DDosUpTime" value="<?php echo ($vo["ddosuptime"]); ?>">
                    <p class="help-block">设置过高可能会造成数据库压力增大。</p>
                  </div>
                  <div class="form-group">
                    <label>单位时间访问上限（次）</label>
                    <input class="form-control" placeholder="单位时间访问上限" name="DDosUpCount" value="<?php echo ($vo["ddosupcount"]); ?>">
                    <p class="help-block">每单位时间最高访问次数。</p>
                  </div>
                  <div class="form-group">
                    <label>过量访问处理</label>
                    <div class="radio">
                      <label>
                        <input type="radio" name="DDosType" id="DDosType1" value="lock" <?php if($vo["ddostype"] == 'lock'): ?>checked<?php endif; ?>>
                        限时锁定IP </label>
                      <label>
                        <input type="radio" name="DDosType" id="DDosType2" value="vcode">
                        请求输入验证码 </label>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="单次IP锁定时间" name="DDoslockTime" value="<?php echo ($vo["ddoslocktime"]); ?>">
...
<script>
  var SCOPE={
    'save_url':'admin.php?c=ddos&a=add',
    'jump_url':'admin.php?c=ddos',
  }
</script>
<script src="/Public/js/admin/common.js"></script>
