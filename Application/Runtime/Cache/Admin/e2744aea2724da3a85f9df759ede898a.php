            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  <?php if(is_array($websiteMenu)): foreach($websiteMenu as $key=>$websiteMenu): ?><option value="<?php echo ($websiteMenu["menu_id"]); ?>"><?php echo ($websiteMenu["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
